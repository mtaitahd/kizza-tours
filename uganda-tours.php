...
$pageSeo = seoPageMeta('uganda-tours');
$siteWhatsapp = getSetting('site_whatsapp', SITE_WHATSAPP);
$sitePhone = getSetting('site_phone', SITE_PHONE);
$faqs = [
    ['question' => __('tour_ug_faq_q1'), 'answer' => __('tour_ug_faq_a1')],
    ['question' => __('tour_ug_faq_q2'), 'answer' => __('tour_ug_faq_a2')],
    ['question' => __('tour_ug_faq_q3'), 'answer' => __('tour_ug_faq_a3')],
    ['question' => __('tour_ug_faq_q4'), 'answer' => __('tour_ug_faq_a4')],
    ['question' => __('tour_ug_faq_q5'), 'answer' => __('tour_ug_faq_a5')],
];
$heroImg = getMediaUrl('uganda_tours_image', getMediaUrl('hero_poster', ''));
...
<script type="application/ld+json"><?php echo json_encode(seoBreadcrumbSchema([
    ...
    ['name' => 'Uganda Tours', 'url' => SITE_URL . '/uganda-tours'],
...
<section class="inner-hero" style="<?= $heroBg ?>">
    <div class="container text-center">
        <span class="section-subtitle"><?php echo __('tour_ug_subtitle'); ?></span>
        <h1 style="color: var(--white); font-size: clamp(2.5rem, 5vw, 4rem);"><?php echo __('tour_ug_title'); ?></h1>
        <p style="color: rgba(255,255,255,0.8); max-width: 700px; margin: 1rem auto 0; font-size: 1.1rem;">
            <?php echo __('tour_ug_desc'); ?>
        </p>
    </div>
</section>
    ...
    <div class="container">
        <div class="row align-items-center g-5 mb-5">
            <div class="col-lg-6" data-aos="fade-right">
                <span class="section-subtitle"><?php echo __('tour_ug_why_subtitle'); ?></span>
                <h2 class="section-title"><?php echo __('tour_ug_why_title'); ?></h2>
                <p style="color: var(--text-light); font-size: 1.1rem; line-height: 1.9;"><?php echo __('tour_ug_why_desc_1'); ?></p>
                <p style="color: var(--text-light); font-size: 1.1rem; line-height: 1.9;"><?php echo __('tour_ug_why_desc_2'); ?></p>
                <div class="mt-4">
                    <a href="<?php echo SITE_URL; ?>/book-tour" class="btn btn-premium btn-gold"><i class="fas fa-calendar-check"></i> <?php echo __('tour_ug_btn_book'); ?></a>
                    <a href="https://wa.me/<?php echo $siteWhatsapp; ?>" class="btn btn-premium btn-whatsapp ms-2"><i class="fab fa-whatsapp"></i> <?php echo __('tour_ug_btn_inquire'); ?></a>
                </div>
            </div>
        ...
        <div class="row g-4 mb-5">
            <div class="col-12 text-center" data-aos="fade-up">
                <span class="section-subtitle"><?php echo __('tour_ug_routes_subtitle'); ?></span>
                <h2 class="section-title"><?php echo __('tour_ug_routes_title'); ?></h2>
            </div>
            <div class="col-md-6 col-lg-4" data-aos="fade-up">
                <div class="story-card">
                    <div class="story-card-icon" style="margin: 0 auto 1rem;"><i class="fas fa-route"></i></div>
                    <h3><?php echo __('tour_ug_route_1_title'); ?></h3>
                    <p><?php echo __('tour_ug_route_1_desc'); ?></p>
                </div>
            </div>
            <div class="col-md-6 col-lg-4" data-aos="fade-up" data-aos-delay="100">
                <div class="story-card">
                    <div class="story-card-icon" style="margin: 0 auto 1rem;"><i class="fas fa-route"></i></div>
                    <h3><?php echo __('tour_ug_route_2_title'); ?></h3>
                    <p><?php echo __('tour_ug_route_2_desc'); ?></p>
                </div>
            </div>
            <div class="col-md-6 col-lg-4" data-aos="fade-up" data-aos-delay="200">
                <div class="story-card">
                    <div class="story-card-icon" style="margin: 0 auto 1rem;"><i class="fas fa-route"></i></div>
                    <h3><?php echo __('tour_ug_route_3_title'); ?></h3>
                    <p><?php echo __('tour_ug_route_3_desc'); ?></p>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="container">
        <div class="row justify-content-center">
            <div class="col-lg-8" data-aos="fade-up">
                <span class="section-subtitle"><?php echo __('tour_ug_faq_subtitle'); ?></span>
                <h2 class="section-title"><?php echo __('tour_ug_faq_title'); ?></h2>
...
<section class="section-padding">
    <div class="container">
        <div class="text-center mb-5" data-aos="fade-up">
            <span class="section-subtitle"><?php echo __('tour_ug_related_subtitle'); ?></span>
            <h2 class="section-title"><?php echo __('tour_ug_related_title'); ?></h2>
        </div>
        <div class="row g-4">
            <?php $related = seoRelatedTours('Uganda', 4); ?>
                ...
                <div class="package-card">
                    <div class="package-card-image">
                        <?php
                            ...
                            if (empty($rImg)) {
                                $ik = '';
                                if (stripos($rt, 'gorilla trekking') !== false) $ik = 'uganda_gorilla_adventure_image';
                                elseif (stripos($rt, 'wildlife') !== false) $ik = 'uganda_wildlife_image';
                    ...
                    <div class="package-card-body">
                        ...
                        <a href="<?php echo SITE_URL; ?>/safari/<?php echo htmlspecialchars($r['slug'] ?? ''); ?>" class="btn btn-premium btn-outline-gold btn-sm w-100"><?php echo __('tour_ug_view_details'); ?></a>
                    </div>
                </div>
            </div>
            <?php endforeach; ?>
