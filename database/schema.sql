...
CREATE TABLE tour_packages (
    ...
    overview_image_1 VARCHAR(255) DEFAULT NULL,
    overview_image_2 VARCHAR(255) DEFAULT NULL,
    overview_image_3 VARCHAR(255) DEFAULT NULL,
    gallery TEXT,
    video_url VARCHAR(255),
...
-- Itinerary Days (structured, per-day tour itinerary)
-- Backward compatible: tour_packages.itinerary TEXT column is preserved and
-- used as a fallback for tours that don't have structured days yet.
